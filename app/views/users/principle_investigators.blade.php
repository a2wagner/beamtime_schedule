...
<div class="col-lg-10 col-lg-offset-1">
    ...
    <table class="table table-striped table-hover">
      <thead>
        <tr>
          <th>Name {{ link_to('users/principle_investigators?sort=asc', '', ['class' => 'nounderline fa fa-sort-alpha-asc hidden-print']) }} {{ link_to('users/principle_investigators?sort=desc', '', ['class' => 'nounderline fa fa-sort-alpha-desc hidden-print']) }}</th>
          <th>Workgroup</th>
          <th>Email</th>
