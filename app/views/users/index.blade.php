...
<div class="col-lg-10 col-lg-offset-1">
    ...
    <table class="table table-striped table-hover">
      <thead>
        <tr>
          <th rowspan="2">Name @if (!Input::has('search')) {{ link_to('users?sort=asc', '', ['class' => 'nounderline fa fa-sort-alpha-asc hidden-print']) }} {{ link_to('users?sort=desc', '', ['class' => 'nounderline fa fa-sort-alpha-desc hidden-print']) }} @endif</th>
          <th rowspan="2">Workgroup</th>
          <th rowspan="2">Email</th>
          <th colspan="3" class="text-center">Phone Number</th>
          @if (Auth::user()->isAdmin())
          <th rowspan="2" class="text-center hidden-print">Actions</th>
          @endif
        </tr>
        <tr>
          <th>Institute</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>@if (Auth::user()->isAdmin() && $user->isAdmin()) <span class="fa fa-user hidden-print"></span> @endif {{ link_to("/users/{$user->username}", $user->first_name." ".$user->last_name) }}</td>
