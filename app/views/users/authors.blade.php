...
<div class="col-lg-10 col-lg-offset-1">
    ...
    <table class="table table-striped table-hover">
      <thead>
        <tr>
          <th>Name {{ link_to('users/authors?sort=asc', '', ['class' => 'nounderline fa fa-sort-alpha-asc hidden-print']) }} {{ link_to('users/authors?sort=desc', '', ['class' => 'nounderline fa fa-sort-alpha-desc hidden-print']) }}</th>
          <th>Workgroup</th>
          <th>Email</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
            @if ($user->isAuthor())
            <a href="/users/{{{$user->id}}}/au" data-method="patch" class="btn btn-warning btn-xs"><span class="fa fa-times-circle"></span> Remove Author</a>
            @else
            <a href="/users/{{{$user->id}}}/au" data-method="patch" class="btn btn-success btn-xs"><span class="fa fa-check-circle"></span> Set Author</a>
            @endif
          </td>
        </tr>
        @endforeach
